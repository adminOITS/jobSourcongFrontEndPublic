...
import { OfferDetailsTabsComponent } from '../../../offers/components/offer-details-tabs/offer-details-tabs.component';
...
import { GlobalInterviewsTableComponent } from '../../../interviews/components/global-interviews-table/global-interviews-table.component';
...
export class ApplicationValidationReviewTabsComponent {
      ...
      if (this.application()) {
        if (this.activeTab() === 'profile') {
          this.candidateService.getCandidateById(
            this.application()?.profile?.candidate?.id!
          );
        }
