...
export enum ApplicationStatusEnum {
  ...
  INTERESTED_BY_CANDIDATE = 'INTERESTED_BY_CANDIDATE',
  MORE_INFO_REQUESTED_BY_CANDIDATE = 'MORE_INFO_REQUESTED_BY_CANDIDATE',
  WAITING_FOR_CANDIDATE_ACTION = 'WAITING_FOR_CANDIDATE_ACTION',
  PUSHED_TO_CLIENT = 'PUSHED_TO_CLIENT',
  REJECTED_BY_CLIENT = 'REJECTED_BY_CLIENT',
  VALIDATED_BY_CLIENT = 'VALIDATED_BY_CLIENT',
  INVALIDATED_BY_CLIENT = 'INVALIDATED_BY_CLIENT',
  UNPUSHED_BY_CLIENT = 'UNPUSHED_BY_CLIENT',
}
